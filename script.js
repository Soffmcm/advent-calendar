...
const content = [
  "Day 1: Hi babyyy, <br> as the first note of this calendar i thought i’d just explain what this is all about.<br> After that  time u told me that you wanted an advent calendar, i thought “omg let me look for a lipgloss one online and try to get it for her”<br> but unfortunately i don’t have 60€ (as the cheapest option),<br> but then i thought “wait why don’t i try do something else?”<br> And i came up with the idea of making this kind of calendar :) <br> which i thought could be sweet too :) <br>But how does it work? <br> Well every day a new “day” will unlock <br> and you can see a little note that i left for you for that day :) <br> and don’t even try to open future days because i made sure that <br> they are locked until its time to open them :))",
